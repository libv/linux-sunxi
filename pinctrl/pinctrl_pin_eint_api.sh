...
# Date  : 2013-06-10
#
# Goals: test sunxi pinctrl pin eint api.
# usage:
#      
# parameter:
#
...
#test PA00
	echo 0 > /sys/class/sunxi_pinctrl_test_init_class/sunxi_pinctrl_test/gpio_index
	echo 7 > /sys/class/sunxi_pinctrl_test_init_class/sunxi_pinctrl_test/exec
fi
