...
# Date  : 2013-06-10
#
# Goals: test sunxi pinctrl request gpio resource api.
# usage:
#      
# parameter:
#
...
#test PA04	
	...
	echo 3 > /sys/class/sunxi_pinctrl_test_init_class/sunxi_pinctrl_test/exec
#test PB02
	echo 33 > /sys/class/sunxi_pinctrl_test_init_class/sunxi_pinctrl_test/gpio_index
	echo 3 > /sys/class/sunxi_pinctrl_test_init_class/sunxi_pinctrl_test/exec
fi
