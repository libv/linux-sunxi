...
# Date  : 2013-06-10
#
# Goals: test pinctrl repeat request all resource api.
# usage:
#      
# parameter:
#
...
if [ ${TEST_HOST_NAME} == "sun8i" ]; then
	echo Vdevice > /sys/class/sunxi_pinctrl_test_init_class/sunxi_pinctrl_test/dev_name
	echo 1 > /sys/class/sunxi_pinctrl_test_init_class/sunxi_pinctrl_test/exec
fi
