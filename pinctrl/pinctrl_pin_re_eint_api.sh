...
# Date  : 2013-06-10
#
# Goals: test sunxi pinctrl pin repeat eint api.
# usage:
#      
# parameter:
#
...
#test PA01
	echo 1 > /sys/class/sunxi_pinctrl_test_init_class/sunxi_pinctrl_test/gpio_index
	echo 8 > /sys/class/sunxi_pinctrl_test_init_class/sunxi_pinctrl_test/exec
fi
