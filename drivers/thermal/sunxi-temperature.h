...
#define THS_CTRL_REG0_VALUE	(0x00a73fff)
#define THS_CTRL_REG1_VALUE	(0x120)
#define THS_PRO_CTRL_REG_VALUE	(0x10000)
...
#define THS_CTRL_VALUE		(0x0f)
#define THS_INT_CTRL_VALUE	(0x0ff)
