...
u4Byte	GLCoexVerDate8723b1Ant=20130830;
u4Byte	GLCoexVer8723b1Ant=0x44;
	...
	)
{
	switch(type)
	{
		...
		case 3:
			...
			break;
		case 4:
			halbtc8723b1ant_CoexTable(pBtCoexist, bForceExec, 0xffffffff, 0xffffffff, 0xffffff, 0x3);
			break;
		case 5:
			halbtc8723b1ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0x5fff5fff, 0xffffff, 0x3);
			break;
		case 6:
			halbtc8723b1ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5a5a5a5a, 0xffffff, 0x3);
			break;
		case 7:
	...
	if(bTurnOn)
	{
		switch(type)
		{
			...
			case 2:
				...
				break;
			case 3:
				halbtc8723b1ant_SetFwPstdma(pBtCoexist, 0x51, 0x1d, 0x1d, 0x0, 0x50);
				break;
			case 4:
			...
			case 5:
				...
				break;
			case 6:
				halbtc8723b1ant_SetFwPstdma(pBtCoexist, 0x13, 0xa, 0x3, 0x0, 0x0);
				break;
			case 7:
			...
			case 10:	
				...
				break;
			case 11:	
				halbtc8723b1ant_SetFwPstdma(pBtCoexist, 0x51, 0x14, 0x03, 0x10, 0x50);
				rssiAdjustVal = 20;
				break;
			case 12:
	...
	)
{
	...
	// power save state
	/*
	if(BT_8723B_1ANT_BT_STATUS_ACL_BUSY == pCoexDm->btStatus && !pBtCoexist->btLinkInfo.bHidOnly)
...
VOID
EXhalbtc8723b1ant_StackOperationNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
	)
{
