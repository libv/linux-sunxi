...
u4Byte	GLCoexVerDate8812a2Ant=20130801;
u4Byte	GLCoexVer8812a2Ant=0x30;
	...
	)
{
	...
	if(BTC_8812A_1ANT_SWITCH_TO_WIFI == switchTo)
	{
		u1Tmp |= BIT3;
		u1Tmp &= ~BIT2;
	}
	else if(BTC_8812A_1ANT_SWITCH_TO_BT == switchTo)
	{
		u1Tmp &= ~BIT3;
		u1Tmp |= BIT2;
	}
	...
	)
{
	...
	{
		case 0:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x55555555, 0xffffff, 0x3);
			break;
		case 1:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x5afa5afa, 0xffffff, 0x3);
			break;
		case 2:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x5a5a5a5a, 0x5a5a5a5a, 0xffffff, 0x3);
			break;
		case 3:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0xaaaaaaaa, 0xaaaaaaaa, 0xffffff, 0x3);
			break;
		case 4:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0xffffffff, 0xffffffff, 0xffffff, 0x3);
			break;
		case 5:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0x5fff5fff, 0xffffff, 0x3);
			break;
		case 6:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5a5a5a5a, 0xffffff, 0x3);
			break;
		case 7:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5afa5afa, 0xffffff, 0x3);
			break;
		case 8:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0xdfdfdfdf, 0x5a5a5a5a, 0xffffff, 0x3);
			break;
		case 9:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5aea5aea, 0xffffff, 0x3);
			break;
		case 10:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5aff5aff, 0xffffff, 0x3);
			break;
		case 11:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0x55ff55ff, 0x5a5f5a5f, 0xffffff, 0x3);
			break;
		case 12:
			halbtc8812a2ant_CoexTable(pBtCoexist, bForceExec, 0xddffddff, 0xddffddff, 0xffffff, 0x3);
			break;
		default:
			break;
	}
	...
	)
{
	...
	if(bTurnOn)
	{
		switch(type)
		{
			...
			default:
				...
				break;
			case 2:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x12, 0x12, 0xe1, 0x90);
				break;
			case 3:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x1c, 0x3, 0xf1, 0x90);
				break;
			case 4:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x10, 0x03, 0xf1, 0x90);
				break;
			case 5:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x1a, 0x1a, 0x60, 0x90);
				break;
			case 6:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x12, 0x12, 0x60, 0x90);
				break;
			case 7:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x1c, 0x3, 0x70, 0x90);
				break;
			case 8:	
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xa3, 0x10, 0x3, 0x70, 0x90);
				break;
			case 9:	
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x1a, 0x1a, 0xe1, 0x10);
				break;
			case 10:	
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x12, 0x12, 0xe1, 0x10);
				break;
			case 11:	
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x1c, 0x03, 0xf1, 0x10);
				break;
			case 12:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x10, 0x03, 0xf1, 0x10);
				break;
			case 13:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x1a, 0x1a, 0x60, 0x10);
				break;
			case 14:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x12, 0x12, 0x60, 0x10);
				break;
			case 15:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x1c, 0x03, 0x70, 0x10);
				break;
			case 16:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xe3, 0x10, 0x03, 0x70, 0x10);
				break;
			case 17:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0xa3, 0x2f, 0x2f, 0x60, 0x90);
				break;
			case 18:
	...
	else
	{
		...
		{
			case 0:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0x0, 0x0, 0x0, 0x40, 0x0);
				break;
			case 1:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0x0, 0x0, 0x0, 0x48, 0x0);
				break;
			default:
				halbtc8812a2ant_SetFwPstdma(pBtCoexist, 0x0, 0x0, 0x0, 0x40, 0x0);
				break;
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				halbtc8812a2ant_CoexTableWithType(pBtCoexist, NORMAL_EXEC, 7);
				halbtc8812a2ant_PsTdma(pBtCoexist, NORMAL_EXEC, TRUE, 21);
				halbtc8812a2ant_FwDacSwingLvl(pBtCoexist, NORMAL_EXEC, 6);
				halbtc8812a2ant_DecBtPwr(pBtCoexist, NORMAL_EXEC, 0);
				halbtc8812a2ant_SwMechanism1(pBtCoexist,FALSE,FALSE,FALSE,FALSE);
				halbtc8812a2ant_SwMechanism2(pBtCoexist,FALSE,FALSE,FALSE,0x18);
	...
	)
{
			...
			(btRssiState == BTC_RSSI_STATE_STAY_MEDIUM) )
	{
		halbtc8812a2ant_DecBtPwr(pBtCoexist, NORMAL_EXEC, 2);
			...
			(btRssiState == BTC_RSSI_STATE_STAY_HIGH) )
	{
		halbtc8812a2ant_DecBtPwr(pBtCoexist, NORMAL_EXEC, 6);
	}

	pBtCoexist->fBtcGet(pBtCoexist, BTC_GET_U4_WIFI_BW, &wifiBw);

	halbtc8812a2ant_CoexTableWithType(pBtCoexist, NORMAL_EXEC, 12);
	...
	)
{
	...
	wifiRssiState = halbtc8812a2ant_WifiRssiState(pBtCoexist, 0, 2, 15, 0);
	btRssiState = halbtc8812a2ant_BtRssiState(2, 35, 0);
	...
	)
{
		...
		(btRssiState == BTC_RSSI_STATE_STAY_HIGH) )
	{
		...
		if(BTC_WIFI_BW_HT40 == wifiBw)
		{
			halbtc8812a2ant_FwDacSwingLvl(pBtCoexist, NORMAL_EXEC, 3);
		}
		else
		{
			halbtc8812a2ant_FwDacSwingLvl(pBtCoexist, NORMAL_EXEC, 6);
	...
	)
{
	...
	halbtc8812a2ant_AntennaSwitch(pBtCoexist,
		BTC_8812A_1ANT_SWITCH_TO_BT);
...
VOID
EXhalbtc8812a2ant_StackOperationNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte				type
	)
{
