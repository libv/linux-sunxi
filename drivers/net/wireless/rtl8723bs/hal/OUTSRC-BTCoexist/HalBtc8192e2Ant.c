...
u4Byte	GLCoexVerDate8192e2Ant=20130828;
u4Byte	GLCoexVer8192e2Ant=0x32;
	...
	)
{
	...
	{
		case 0:
			halbtc8192e2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x55555555, 0xffffff, 0x3);
			break;
		case 1:
			halbtc8192e2ant_CoexTable(pBtCoexist, bForceExec, 0x5a5a5a5a, 0x5a5a5a5a, 0xffffff, 0x3);
			break;
		case 2:
			halbtc8192e2ant_CoexTable(pBtCoexist, bForceExec, 0x55555555, 0x5f5b5f5b, 0xffffff, 0x3);
			break;
		case 3:
			halbtc8192e2ant_CoexTable(pBtCoexist, bForceExec, 0x5fff5fff, 0x5f5b5f5b, 0xffffff, 0x3);
			break;
		case 4:
			halbtc8192e2ant_CoexTable(pBtCoexist, bForceExec, 0xddffddff, 0xddffddff, 0xffffff, 0x3);
			break;
	...
	if(bTurnOn)
	{
		switch(type)
		{
			...
			case 16:
				...
				break;
			case 17:
				halbtc8192e2ant_SetFwPstdma(pBtCoexist, 0xa3, 0x2f, 0x2f, 0x60, 0x90);
				break;
			case 18:
	...
	)
{
	...
	halbtc8192e2ant_FwDacSwingLvl(pBtCoexist, NORMAL_EXEC, 4);
			...
			(btRssiState == BTC_RSSI_STATE_STAY_MEDIUM) )
	{
		halbtc8192e2ant_DecBtPwr(pBtCoexist, NORMAL_EXEC, 2);
			...
			(btRssiState == BTC_RSSI_STATE_STAY_HIGH) )
	{
		halbtc8192e2ant_DecBtPwr(pBtCoexist, NORMAL_EXEC, 6);
	}
	...
	)
{
	...
	wifiRssiState = halbtc8192e2ant_WifiRssiState(pBtCoexist, 0, 2, 15, 0);
	btRssiState = halbtc8192e2ant_BtRssiState(2, 35, 0);
	...
	{
//Allen		halbtc8192e2ant_CoexTableWithType(pBtCoexist, NORMAL_EXEC, 9);
		halbtc8192e2ant_CoexTableWithType(pBtCoexist, NORMAL_EXEC, 3);
	}
	...
	{
		halbtc8192e2ant_DecBtPwr(pBtCoexist, NORMAL_EXEC, 2);
		halbtc8192e2ant_TdmaDurationAdjust(pBtCoexist, TRUE, FALSE, 1);
	}
	else
	{
		halbtc8192e2ant_DecBtPwr(pBtCoexist, NORMAL_EXEC, 0);
		halbtc8192e2ant_TdmaDurationAdjust(pBtCoexist, TRUE, TRUE, 1);
	}
...
//Allen	halbtc8192e2ant_CoexTableWithType(pBtCoexist, NORMAL_EXEC, 10);
	halbtc8192e2ant_CoexTableWithType(pBtCoexist, NORMAL_EXEC, 2);
	...
	)
{
		...
		(btRssiState == BTC_RSSI_STATE_STAY_HIGH) )
	{
		...
		if(BTC_WIFI_BW_HT40 == wifiBw)
		{
			halbtc8192e2ant_FwDacSwingLvl(pBtCoexist, NORMAL_EXEC, 3);
//Allen			halbtc8192e2ant_CoexTableWithType(pBtCoexist, NORMAL_EXEC, 11);
			halbtc8192e2ant_CoexTableWithType(pBtCoexist, NORMAL_EXEC, 3);
		}
		else
		{
	...
	)
{
	...
	pBtCoexist->fBtcWrite1Byte(pBtCoexist, 0x4f, 0x6);
	...
	)
{
	...
	if(BT_INFO_SRC_8192E_2ANT_WIFI_FW != rspSource)
	{
		...
		// work around for bt patch auto report wrong rssi (auto report rssi always=0)
		if(BT_INFO_SRC_8192E_2ANT_BT_RSP == rspSource)
		{
			pCoexSta->btRssi =
