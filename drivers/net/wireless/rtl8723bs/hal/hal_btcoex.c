...
void EXhalbtcoutsrc_StackOperationNotify(PBTC_COEXIST pBtCoexist, u8 type)
{
	...
	{
		if (pBtCoexist->boardInfo.btdmAntNum == 2)
			EXhalbtc8821a2ant_StackOperationNotify(pBtCoexist, stackOpType);
		else if (pBtCoexist->boardInfo.btdmAntNum == 1)
			EXhalbtc8821a1ant_StackOperationNotify(pBtCoexist, stackOpType);
	}
	else if (IS_HARDWARE_TYPE_8723B(pBtCoexist->Adapter))
	{
		if (pBtCoexist->boardInfo.btdmAntNum == 2)
	...
	{
		if (pBtCoexist->boardInfo.btdmAntNum == 2)
			EXhalbtc8188c2ant_StackOperationNotify(pBtCoexist, stackOpType);
	}
	else if (IS_HARDWARE_TYPE_8192D(pBtCoexist->Adapter))
	{
		if (pBtCoexist->boardInfo.btdmAntNum == 2)
			EXhalbtc8192d2ant_StackOperationNotify(pBtCoexist, stackOpType);
	}
	else if (IS_HARDWARE_TYPE_8192E(pBtCoexist->Adapter))
	{
		if (pBtCoexist->boardInfo.btdmAntNum == 2)
			EXhalbtc8192e2ant_StackOperationNotify(pBtCoexist, stackOpType);
		else if (pBtCoexist->boardInfo.btdmAntNum == 1)
			EXhalbtc8192e1ant_StackOperationNotify(pBtCoexist, stackOpType);
	}
	else if (IS_HARDWARE_TYPE_8812(pBtCoexist->Adapter))
	{
		if (pBtCoexist->boardInfo.btdmAntNum == 2)
			EXhalbtc8812a2ant_StackOperationNotify(pBtCoexist, stackOpType);
		else if (pBtCoexist->boardInfo.btdmAntNum == 1)
...
u8 hal_btcoex_1AntRpwmVal(PADAPTER padapter)
{
	return GLBtCoexist.btInfo.rpwm1Ant;
}

u8 hal_btcoex_1AntLpsVal(PADAPTER padapter)
{
