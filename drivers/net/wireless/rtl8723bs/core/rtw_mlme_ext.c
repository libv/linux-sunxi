...
bool rtw_port_switch_chk(_adapter *adapter)
{
	...
	DBG_871X(FUNC_ADPT_FMT"\n"
		"if_port0_mlmeinfo->state:0x%08x, p2p_state:%d, %d\n"
		"if_port1_mlmeinfo->state:0x%08x, p2p_state:%d, %d\n",
		FUNC_ADPT_ARG(adapter),
		if_port0_mlmeinfo->state, rtw_p2p_state(&if_port0->wdinfo), rtw_p2p_chk_state(&if_port0->wdinfo, P2P_STATE_NONE),
		if_port1_mlmeinfo->state, rtw_p2p_state(&if_port1->wdinfo), rtw_p2p_chk_state(&if_port1->wdinfo, P2P_STATE_NONE));
