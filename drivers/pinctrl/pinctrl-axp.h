...
#define AXP_PINCTRL_GPIO0	PINCTRL_PIN(0, "GPIO0")
#define AXP_PINCTRL_GPIO1	PINCTRL_PIN(1, "GPIO1")
#define AXP_PINCTRL_GPIO2	PINCTRL_PIN(2, "GPIO2")
#define AXP_PINCTRL_GPIO3	PINCTRL_PIN(3, "GPIO3")
#define AXP_PINCTRL_GPIO4	PINCTRL_PIN(4, "GPIO4")
#define AXP_PINCTRL_GPIO5	PINCTRL_PIN(5, "GPIO5")
...
* GPIO6<-->SWOUT(PIN 22)
*/
#define AXP15_GPIO5_CFG                   (AXP15_WAKEUP_FUNC)//0x35
#define AXP15_GPIO6_CFG                   (AXP15_BC_LDO_EN)//0x11
