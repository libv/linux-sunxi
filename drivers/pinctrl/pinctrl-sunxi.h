...
static inline void sunxi_write_reg(u32 value,u32 *reg)
{
	writel(value,reg);	
	if(unlikely(0xF1C208D8 == (int)(reg))) 
		writel(0, (volatile u32 *)(0xF1C20CD8)); 	
	else if(unlikely(0xF1C208F8 == (int)(reg))) 
		writel(0,(volatile u32 *)(0xF1C20CF8)); 
	else if(unlikely(0xF1C20918 == (int)(reg))) 
		writel(0, (volatile u32 *)(0xF1C20D18)); 
}
