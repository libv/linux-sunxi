...
#define USI_UNA_PRODUCT_ID	0x0e8d
...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(USI_UNA_PRODUCT_ID, USI_UNA_PRODUCT_3COM)},
	{ USB_DEVICE(USI_UNA_PRODUCT_ID, USI_UNA_PRODUCT_2COM)},
	{ } /* Terminating entry */
};
			...
			const struct usb_device_id *id)
{
	...
	if (serial->dev->descriptor.idProduct == USI_UNA_PRODUCT_3COM && 
		serial->interface->cur_altsetting->desc.bInterfaceClass != 2 && 
		serial->interface->cur_altsetting->desc.bInterfaceClass != 3)
		return -ENODEV;
