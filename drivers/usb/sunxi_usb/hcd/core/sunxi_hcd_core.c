...
void sunxi_hcd_start(struct sunxi_hcd *sunxi_hcd)
{
    ...
    DMSG_DBG_HCD("sunxi_hcd_start: devctl = 0x%x, epmask = 0x%x\n",
		         USBC_Readb(USBC_REG_DEVCTL(usbc_base)), sunxi_hcd->epmask);
