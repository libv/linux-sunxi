...
#ifndef __SUNXI_HCI_SUN6I_H__
#define __SUNXI_HCI_SUN6I_H__
...
#define  DMSG_ERR(format,args...)   			printk("[sunxi_hci_sun6i]: "format,##args)
#define  DMSG_PRINT(format,args...)   	  printk("[sunxi_hci_sun6i]: "format,##args)
...
struct sunxi_hci_hcd{
	...
	__u8 power_flag;                    /* flag. 锟角凤拷☠☠       */

    __u8 used;                          /* flag. ☠☠☠锟角凤拷使☠ */
	__u8 probe;                         /* ☠☠☠☠始☠ */
	__u8 host_init_state;				/* usb ☠☠☠锟侥筹拷始☠状态☠0 : ☠☠☠. 1 : ☠☠ */
	__u8 usb_restrict_flag;
	__u8 usbc_type;                     /* usb controller type  */
	__u8 not_suspend;                   /* flag. ☠☠☠         */
