...
static int goodix_init_panel(struct goodix_ts_data *ts)
{
	...
	if (screen_max_x == 1024 || screen_max_y == 1024) {
		data_info0[72] = info_1024x768[0];
		data_info0[73] = info_1024x768[1];
		data_info1[72] = info_1024x768[0];
		data_info1[73] = info_1024x768[1];
	} else if (screen_max_x == 1280 || screen_max_y == 1280) {
		data_info0[72] = info_1280x800[0];
		data_info0[73] = info_1280x800[1];
		data_info1[72] = info_1280x800[0];
		data_info1[73] = info_1280x800[1];
	}
...
☠锟杰ｏ拷
	☠☠☠探锟解函☠
	☠注☠☠☠时☠锟矫ｏ拷要☠☠诙锟接拷锟client☠☠
	☠☠IO,锟叫断碉拷☠源☠锟诫；锟借备注锟结；☠☠☠☠始☠锟饺癸拷☠
☠☠☠
	client☠☠☠☠☠锟借备锟结构☠
	id☠锟借备ID
return☠
