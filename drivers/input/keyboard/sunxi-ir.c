...
{
	dprintk(DEBUG_SUSPEND, "enter earlysuspend: sunxi_ir_suspend. \n");
...
{
	dprintk(DEBUG_SUSPEND, "enter laterresume: sunxi_ir_resume. \n");
...
static int sunxi_ir_suspend(struct device *dev)
{
	...
	dprintk(DEBUG_SUSPEND, "enter: sunxi_ir_suspend. \n");
...
static int sunxi_ir_resume(struct device *dev)
{
	...
	dprintk(DEBUG_SUSPEND, "enter: sunxi_ir_resume. \n");
