...
static struct device_attribute sensor_dev_attr_als_enable = __ATTR(enable, S_IRUGO | S_IWUSR | S_IWGRP,
    ls_enable_show, ls_enable_store);
static struct device_attribute sensor_dev_attr_als_delay = __ATTR(delay, S_IRUGO | S_IWUSR | S_IWGRP,
    ls_delay_show, ls_delay_store);


static struct device_attribute sensor_dev_attr_prx_enable = __ATTR(enable, S_IRUGO | S_IWUSR | S_IWGRP,
    ps_enable_show, ps_enable_store);
static struct device_attribute sensor_dev_attr_prx_delay = __ATTR(delay, S_IRUGO | S_IWUSR | S_IWGRP,
