...
#define MDFS_CFG            0x0480
#define DRAM_CFG            0x0484

#define MBUS_GATE           0x0488
...
#define	MBUS0_CFG						0x04e4
#define MBUS1_CFG						0x04e8
...
#define F_N8X6_K20X2_P16X1(nv,kv,pv) 					 FACTOR_ALL(nv,8,6, kv,20,2, 0,0,0, pv,16,1, 0,  0, 0, 0,0,0)	
#define F_N8X6_K20X2_P0X2_D1S16X1(nv,kv,pv,d1v) 	 FACTOR_ALL(nv,8,6, kv,20,2, 0,0,0, pv,0, 2, d1v,16,1, 0,0,0)	
#define F_N8X6_K20X2_D1S16X1_D2S18X1(nv,kv,d1v,d2v) FACTOR_ALL(nv,8,6, kv,20,2, 0,0,0, 0, 0, 0, d1v,16,1, d2v,18,1)	
#define F_N8X6_K20X2_D1S16X1(nv,kv,d1v) FACTOR_ALL(nv,8,6, kv,20,2, 0,0,0, 0, 0, 0, d1v,16,1, 0,0,0) 
#endif
