...
static __u32 suspend_status = 0;//0:normal; g_suspend_status&1 != 0:in early_suspend; g_suspend_status&2 != 0:in suspend;
...
{
	{
		.start = (int)SUNXI_DE_FE0_VBASE,
		.end   = (int)SUNXI_DE_FE0_VBASE + 0x22c,
		.flags = IORESOURCE_MEM,
		.name  = "fe0",
	},
	{
		.start = (int)SUNXI_DE_FE1_VBASE,
		.end   = (int)SUNXI_DE_FE1_VBASE + 0x22c,
		.flags = IORESOURCE_MEM,
		.name  = "fe1",
	},
	{
		.start = (int)SUNXI_DE_BE0_VBASE,
		.end   = (int)SUNXI_DE_BE0_VBASE + 0x9fc,
		.flags = IORESOURCE_MEM,
		.name  = "be0",
	},
	{
		.start = (int)SUNXI_DE_BE1_VBASE,
		.end   = (int)SUNXI_DE_BE1_VBASE + 0x9fc,
		.flags = IORESOURCE_MEM,
		.name  = "be1",
	},
	{
		.start = (int)SUNXI_LCD0_VBASE,
		.end   = (int)SUNXI_LCD0_VBASE + 0x3fc,
		.flags = IORESOURCE_MEM,
		.name  = "lcd0",
	},
	{
		.start = (int)SUNXI_LCD1_VBASE,
		.end   = (int)SUNXI_LCD1_VBASE + 0x3fc,
		.flags = IORESOURCE_MEM,
		.name  = "lcd1",
	},
	{
		.start = (int)SUNXI_DEU0_VBASE,
		.end   = (int)SUNXI_DEU0_VBASE + 0x60,
		.flags = IORESOURCE_MEM,
		.name  = "deu0",
	},
	{
		.start = (int)SUNXI_DEU1_VBASE,
		.end   = (int)SUNXI_DEU1_VBASE + 0x60,
		.flags = IORESOURCE_MEM,
		.name  = "deu1",
	},
	{
		.start = (int)SUNXI_DRC0_VBASE,
		.end   = (int)SUNXI_DRC0_VBASE + 0xfc,
		.flags = IORESOURCE_MEM,
		.name  = "drc0",
	},
	{
		.start = (int)SUNXI_DRC1_VBASE,
		.end   = (int)SUNXI_DRC1_VBASE + 0xfc,
		.flags = IORESOURCE_MEM,
		.name  = "drc1",
	},
	{
		.start = (int)SUNXI_DE_BE0_VBASE,
		.end   = (int)SUNXI_DE_BE0_VBASE + 0xfc,
		.flags = IORESOURCE_MEM,
		.name  = "cmu0",
	},
	{
		.start = (int)SUNXI_DE_BE1_VBASE,
		.end   = (int)SUNXI_DE_BE1_VBASE + 0xfc,
		.flags = IORESOURCE_MEM,
		.name  = "cmu1",
	},
	{
		.start = (int)SUNXI_MIPI_DSI0_VBASE,
		.end   = (int)SUNXI_MIPI_DSI0_VBASE + 0x2fc,
		.flags = IORESOURCE_MEM,
		.name  = "dsi0",
	},
	{
		.start = (int)SUNXI_MIPI_DSI0_PHY_VBASE,
		.end   = (int)SUNXI_MIPI_DSI0_PHY_VBASE + 0xfc,
		.flags = IORESOURCE_MEM,
		.name  = "dsi0_dphy",
	},
	{
		.start = (int)SUNXI_HDMI_VBASE,
		.end   = (int)SUNXI_HDMI_VBASE + 0x58c,
		.flags = IORESOURCE_MEM,
		.name  = "hdmi",
	},
	{
		.start = (int)SUNXI_CCM_VBASE,
		.end   = (int)SUNXI_CCM_VBASE + 0x2dc,
		.flags = IORESOURCE_MEM,
		.name  = "ccmu",
	},
	{
		.start = (int)SUNXI_PIO_VBASE,
		.end   = (int)SUNXI_PIO_VBASE + 0x27c,
		.flags = IORESOURCE_MEM,
		.name  = "pioc",
	},
	{
		.start = (int)SUNXI_PWM_VBASE,
		.end   = (int)SUNXI_PWM_VBASE + 0x3c,
		.flags = IORESOURCE_MEM,
		.name  = "pwm",
	},
	{
		.start = (int)SUNXI_IRQ_DEBE0,
		.flags = IORESOURCE_IRQ,
		.name  = "be0",
	},
	{
		.start = (int)SUNXI_IRQ_DEBE1,
		.flags = IORESOURCE_IRQ,
		.name  = "be1",
	},
	{
		.start = (int)SUNXI_IRQ_DEFE0,
		.flags = IORESOURCE_IRQ,
		.name  = "fe0",
	},
	{
		.start = (int)SUNXI_IRQ_DEFE1,
		.flags = IORESOURCE_IRQ,
		.name  = "fe1",
	},
	{
		.start = (int)SUNXI_IRQ_DRC01,
		.flags = IORESOURCE_IRQ,
		.name  = "drc0",
	},
	...
	{
		.start = (int)SUNXI_IRQ_LCD0,
		.flags = IORESOURCE_IRQ,
		.name  = "lcd0",
	},
	{
		.start = (int)SUNXI_IRQ_LCD1,
		.flags = IORESOURCE_IRQ,
		.name  = "lcd1",
	},
	{
		.start = (int)SUNXI_IRQ_MIPIDSI,
		.flags = IORESOURCE_IRQ,
		.name  = "dsi0",
	},
};
