...
#define SPI_MODE_3_ACTIVE_		(SPI_POL_ACTIVE_|SPI_PHA_ACTIVE_) /*默☠为模式3*/
/* ☠☠☠☠☠☠ */
#define SPI_CS_HIGH_ACTIVE_		    (0x04)  /*默☠为片选锟酵碉拷平☠效☠☠锟酵碉拷平选☠片选*/
#define SPI_LSB_FIRST_ACTIVE_		(0x08)  /*默☠为锟饺凤拷☠MSB☠☠锟饺凤拷☠☠锟轿*/
#define SPI_DUMMY_ONE_ACTIVE_        (0x10)  /*默☠为☠☠时spi☠☠☠锟皆讹拷☠锟0☠☠txFIFO */
#define SPI_RECEIVE_ALL_ACTIVE_      (0x20)  /*默☠为☠☠☠锟矫碉拷burst☠☠☠锟酵碉拷时☠☠锟rxFIFO☠锟秸碉拷☠☠ */
