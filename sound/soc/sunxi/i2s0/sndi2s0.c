...
struct snd_soc_dai_ops sndi2s0_dai_ops = {
...
struct snd_soc_dai_driver sndi2s0_dai = {
	.name = "sndi2s0",
...
i2s0_used = 1;
	...
	if (i2s0_used) {
       ...
       printk("[I2S]sndi2s0 cannot find any using configuration for controllers, return directly!\n");
       return 0;
    }
