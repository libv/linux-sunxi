...
struct regulator* hp_ldo = NULL;
char *hp_ldo_str = NULL;
...
/*for phone call flag*/
bool codec_phonein_en			= false;
bool codec_speaker_en           = false;
bool codec_mainmic_en           = false;
bool codec_phoneout_en          = false;
bool codec_lineinin_en          = false;
bool codec_lineincap_en         = false;
bool codec_headsetmic_en        = false;
bool codec_speakerout_en        = false;
bool codec_adcphonein_en        = false;
bool codec_earpieceout_en       = false;
bool codec_dacphoneout_en       = false;
bool codec_voice_record_en      = false;
bool codec_headphoneout_en      = false;
bool codec_phonein_left_en		= false;
bool codec_speakerout_lntor_en	= false;
bool codec_headphoneout_lntor_en= false;
bool codec_dacphoneout_reduced_en=false;
bool codec_noise_reduced_adcin_en=false;
int codec_speaker_headset_earpiece_en=0;
...
* 	this function just used for the system voice(such as music and moive voice and so on).
*/
int codec_headphone_play_open(void)
{
	int headphone_vol = 0;
	script_item_u val;
	script_item_value_type_e  type;
...
int codec_earpiece_play_open(void)
{
	int earpiece_vol = 0;
	script_item_u val;
	script_item_value_type_e  type;
...
* 	this function just used for the system voice(such as music and moive voice and so on).
*/
int codec_pa_and_headset_play_open(void)
{
...
*/
int codec_voice_main_mic_capture_open(void)
{
	/*enable mic1 pa*/
...
*/
int codec_voice_headset_mic_capture_open(void)
{
...
*/
int codec_voice_linein_capture_open(void)
{
	/*enable LINEINR ADC*/
...
*/
int codec_noise_reduced_capture_open(void)
{
	/*enable mic1 pa*/
	codec_wr_control(SUNXI_MIC_CTRL, 0x1, MIC1AMPEN, 0x1);
	/*enable Master microphone bias*/
...
int codec_dev_free(struct snd_device *device)
{
	return 0;
};
...
*/
int codec_set_lineinin(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_get_lineinin(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_lineincap(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_get_lineincap(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_speakerout_lntor(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int pa_vol = 0;
	script_item_u val;
...
*	lntor:left negative to right
*/
int codec_get_speakerout_lntor(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_speakerout(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int pa_vol = 0;
	script_item_u val;
...
int codec_get_speakerout(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
* 	lntor:left negative to right
*/
int codec_set_headphoneout_lntor(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int headphone_vol = 0;
	script_item_u val;
...
* 	lntor:left negative to right
*/
int codec_get_headphoneout_lntor(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_headphoneout(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int headphone_vol = 0;
	script_item_u val;
...
int codec_get_headphoneout(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_earpieceout(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int earpiece_vol = 0;
	script_item_u val;
...
int codec_get_earpieceout(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_phonein_left(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_get_phonein_left(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_phonein(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_get_phonein(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_phoneout(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_get_phoneout(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_dacphoneout_reduced_open(void)
{
	/*mute l_pa and r_pa*/
	codec_wr_control(SUNXI_DAC_ACTL, 0x1, LHPPA_MUTE, 0x0);
	codec_wr_control(SUNXI_DAC_ACTL, 0x1, RHPPA_MUTE, 0x0);
...
*/
int codec_set_dacphoneout_reduced(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int ret = 0;
...
int codec_get_dacphoneout_reduced(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_dacphoneout_open(void)
{
	/*mute l_pa and r_pa*/
	codec_wr_control(SUNXI_DAC_ACTL, 0x1, LHPPA_MUTE, 0x0);
	codec_wr_control(SUNXI_DAC_ACTL, 0x1, RHPPA_MUTE, 0x0);
...
*/
int codec_set_dacphoneout(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int ret = 0;
...
int codec_get_dacphoneout(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_adcphonein_open(void)
{
	/*enable PHONEP-PHONEN Boost stage*/
	codec_wr_control(SUNXI_ADC_ACTL, 0x1, RADCMIXMUTEPHONEPN, 0x1);
	/*enable PHONEP-PHONEN Boost stage*/
...
*/
int codec_set_adcphonein(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int ret = 0;
...
int codec_get_adcphonein(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_mainmic(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	script_item_u val;
	script_item_value_type_e  type;
...
int codec_get_mainmic(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_voicerecord(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_get_voicerecord(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_noise_adcin_reduced(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_get_noise_adcin_reduced(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_headsetmic(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	script_item_u val;
	script_item_value_type_e  type;
...
int codec_get_headsetmic(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*/
int codec_set_endcall(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
int codec_get_endcall(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}
...
*	no the phone call.
*/
int codec_set_spk(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int ret = 0, i = 0;
	u32 reg_val;
...
int codec_get_spk(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
*	no the phone call.
*/
int codec_set_spk_headset_earpiece(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int i = 0;
	int ret = 0;
...
int codec_get_spk_headset_earpiece(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
