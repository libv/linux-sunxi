...
*/
int codec_wrreg_prcm_bits(unsigned short reg, unsigned int mask, unsigned int value)
{
...
int codec_wr_prcm_control(u32 reg, u32 mask, u32 shift, u32 val)
{
	u32 reg_val;
	reg_val = val << shift;
	mask = mask << shift;
...
void codec_resume_events(struct work_struct *work)
{
