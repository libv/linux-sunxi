/*
 * sound\soc\sunxi\i2s1\sunxi-i2s1.h
...
#ifndef SUNXI_I2S1_H_
#define SUNXI_I2S1_H_
...
#define SUNXI_I2S1BASE 							(0x08007000)
#else
#define SUNXI_I2S1BASE 							(0x01C22400)
#endif
...
#else	
#define SUNXI_I2S1TXFIFO 						(0x0C)
#endif
#define SUNXI_I2S1RXFIFO 						(0x10)

#define SUNXI_I2S1FCTL  							(0x14)
#ifdef CONFIG_ARCH_SUN9I
#define SUNXI_I2S0FCTL_HUBEN				(1<<31)
#else
	#define SUNXI_I2S1FCTL_FIFOSRC				(1<<31)
#endif
