...
void sunxi_snd_txctrl_i2s1(struct snd_pcm_substream *substream, int on)
{
	u32 reg_val;
...
void sunxi_snd_rxctrl_i2s1(struct snd_pcm_substream *substream, int on)
{
	u32 reg_val;	
...
//static script_item_u item_bclk;
//static script_item_u item_lrclk;
//static script_item_u item_dout;
//static script_item_u item_din;
...
static int __init sunxi_i2s1_dev_probe(struct platform_device *pdev)
{
	...
	printk("[I2S]0x01c208e0 = %#x, line:%d\n", readl(0xf1c20800+0xe0), __LINE__);
	printk("[I2S]0x01c208dc = %#x, line:%d\n", readl(0xf1c20800+0xdc), __LINE__);
	#else
	writel(0x773, 0xf1c208e0);
	writel(0x33377777, 0xf1c208dc);
	printk("[I2S]0x01c208e0 = %#x, line:%d\n", readl(0xf1c20800+0xe0), __LINE__);
	printk("[I2S]0x01c208dc = %#x, line:%d\n", readl(0xf1c20800+0xdc), __LINE__);
//	type = script_get_item("i2s1", "pcm_bclk", &item_bclk);
//	if (SCIRPT_ITEM_VALUE_TYPE_PIO != type) {
//		printk("script_get_item return type err\n");
//		return -EFAULT;
//	}
//	/*request gpio*/
//	req_status = gpio_request(item_bclk.gpio.gpio, NULL);
//	if (0 != req_status) {
//		printk("request gpio failed!\n");
//	}
//	gpio_set_value(item_bclk.gpio.gpio, 3);
//	
//	type = script_get_item("i2s1", "pcm_lrclk", &item_lrclk);
//	if (SCIRPT_ITEM_VALUE_TYPE_PIO != type) {
//		printk("script_get_item return type err\n");
//		return -EFAULT;
//	}
//	/*request gpio*/
//	req_status = gpio_request(item_lrclk.gpio.gpio, NULL);
//	if (0 != req_status) {
//		printk("request gpio failed!\n");
//	}
//	gpio_set_value(item_lrclk.gpio.gpio, 3);
//
//	type = script_get_item("i2s1", "pcm_dout", &item_dout);
//	if (SCIRPT_ITEM_VALUE_TYPE_PIO != type) {
//		printk("script_get_item return type err\n");
//		return -EFAULT;
//	}
//	/*request gpio*/
//	req_status = gpio_request(item_dout.gpio.gpio, NULL);
//	if (0 != req_status) {
//		printk("request gpio failed!\n");
//	}
//	gpio_set_value(item_dout.gpio.gpio, 3);
//
//	type = script_get_item("i2s1", "pcm_din", &item_din);
//	if (SCIRPT_ITEM_VALUE_TYPE_PIO != type) {
//		printk("script_get_item return type err\n");
//		return -EFAULT;
//	}
//	/*request gpio*/
//	req_status = gpio_request(item_din.gpio.gpio, NULL);
//	if (0 != req_status) {
//		printk("request gpio failed!\n");
//	}
//	gpio_set_value(item_din.gpio.gpio, 3);
	#endif
printk("%s, line:%d\n", __func__, __LINE__);
...
pcm_select 	= 1;
#else
	type = script_get_item("i2s1", "pcm_used", &val);
	if (SCIRPT_ITEM_VALUE_TYPE_INT != type) {
	...
	type = script_get_item("i2s1", "pcm_select", &val);
	if (SCIRPT_ITEM_VALUE_TYPE_INT != type) {
