/*
 *  arch/arm/mach-sunxi/pm/ccmu-sun8iw3p1.h
 *
 ...
 */
#ifndef __MEM_CCMU_SUN8IW3P1_H__
#define __MEM_CCMU_SUN8IW3P1_H__
...
typedef struct __CCMU_REG_LIST
{
    ...
    volatile __ccmu_pll8_reg0038_t              Pll4Ctl;                //0x0018, PLL4 control
    ...
    volatile __ccmu_pll8_reg0038_t              Pll8Ctl;                //0x0038, PLL8 control
    volatile __u32                              reserved7;              //0x003c, reserved
    volatile __ccmu_mipi_pll_reg0040_t          MipiPllCtl;             //0x0040, MIPI PLL control
    volatile __ccmu_pll8_reg0038_t              Pll9Ctl;                //0x0044, PLL9 control
    volatile __ccmu_pll8_reg0038_t              Pll10Ctl;               //0x0048, PLL10 control
    ...
    volatile __u32        			AhbGate0;               //0x0060, ahb1 clock gate 0
    volatile __u32        			AhbGate1;               //0x0064, ahb1 clock gate 1
    volatile __u32        			Apb1Gate;               //0x0068, apb1 clock gate
    volatile __u32        			Apb2Gate;               //0x006c, apb2 clock gate
    ...
    volatile __u32		                reserved92[3];          //0x0094, reserved
    ...
    volatile __u32                              I2s0;                   //0x00b0, I2s-0 clock
    volatile __u32                              I2s1;                   //0x00b4, I2s-1 clock
    ...
    volatile __u32                              Usb;                    //0x00cc, usb clock
    ...
    volatile __u32                              Adda;                   //0x0140, audio module clock
    ...
    volatile __u32                              PllxBias[11];           //0x220-0x248, pllx bias reg, 6th not exist. 
...
#endif  // #ifndef __MEM_CCMU_SUN8IW3P1_H__