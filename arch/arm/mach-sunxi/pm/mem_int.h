...
enum interrupt_source_e{
	INT_SOURCE_TIMER0   = SUNXI_IRQ_TIMER0,
	INT_SOURCE_TIMER1   = SUNXI_IRQ_TIMER1,
//	INT_SOURCE_TOUCHPNL = SUNXI_IRQ_TOUCHPANEL,
	INT_SOURCE_LRADC    = SUNXI_IRQ_LRADC,
	INT_SOURCE_EXTNMI   = SUNXI_IRQ_NMI,
	INT_SOURCE_MSG_BOX  = SUNXI_IRQ_MBOX,
};
