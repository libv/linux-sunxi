...
static void sun9i_restart(char mode, const char *cmd)
{
	...
	writel((0x1 << 5) | 0x01, (void __iomem *)(SUNXI_R_WDOG_VBASE + R_WDOG_CFG_REG));
	while(1);
}
...
static struct map_desc sunxi_io_desc[] __initdata = {
	...
	{(u32)SUNXI_SRAM_A1_VBASE,       __phys_to_pfn(SUNXI_SRAM_A1_PBASE),       SUNXI_SRAM_A1_SIZE,       MT_DEVICE},
...
MACHINE_START(SUNXI, "Allwinner AXXX")
	.atag_offset	= 0x100,
